...
const en = {
  ...
  'assistant.taskDetails': 'Task Details',
  'assistant.taskSchedule': 'Schedule',
  'assistant.taskLastResult': 'Last Result',
  'assistant.taskRunHistory': 'Run History',
  'assistant.taskRunNow': 'Run Now',
  'assistant.taskBridgeChannel': 'Bridge Push',
  'assistant.taskBridgeNone': 'None',
  'assistant.taskBridgeNotRunning': 'Bridge not running',
  'assistant.taskRunDuration': 'Duration',
  'assistant.taskNoLogs': 'No execution history',
  'assistant.taskEdit': 'Edit',
  'assistant.taskSave': 'Save',
  'assistant.taskCancel': 'Cancel',
  'assistant.taskPause': 'Pause',
  'assistant.taskResume': 'Resume',
  'assistant.taskName': 'Name',
  ...
  'remoteHost.analyzeLog': 'AI Analyze',
  'remoteHost.analyzeLog.analyzing': 'Analyzing logs...',
  'remoteHost.analyzeLog.success': 'Log analysis completed',
  'remoteHost.analyzeLog.error': 'Failed to analyze log',
  'remoteHost.analyzeLog.noFile': 'No remote log file found',
  'remoteHost.analyzeLog.dialog.title': 'AI Log Analysis',
  'remoteHost.analyzeLog.dialog.close': 'Close',
  'remoteHost.analyzeLog.dialog.reanalyze': 'Re-analyze',
  'remoteHost.analyzeLog.dialog.provider': 'Provider',
  'remoteHost.analyzeLog.dialog.model': 'Model',
  'remoteHost.addHost': 'Add Host',
  'remoteHost.connect': 'Connect',
  'remoteHost.disconnect': 'Disconnect',
  'remoteHost.reconnect': 'Reconnect',
  'remoteHost.status.disconnected': 'Disconnected',
  'remoteHost.status.connecting': 'Connecting',
  'remoteHost.status.connected': 'Connected',
  'remoteHost.status.reconnecting': 'Reconnecting',
  'remoteHost.status.failed': 'Connection Failed',
  'remoteHost.form.name': 'Host Name',
  'remoteHost.form.host': 'Host Address',
  'remoteHost.form.port': 'Port',
  'remoteHost.form.username': 'Username',
  'remoteHost.form.authType': 'Auth Type',
  'remoteHost.form.authKey': 'SSH Key',
  'remoteHost.form.authPassword': 'Password',
  'remoteHost.form.keyPath': 'Key Path',
  'remoteHost.form.password': 'Password',
  'remoteHost.form.workDir': 'Work Directory',
  'remoteHost.setup.checking': 'Checking remote environment...',
  'remoteHost.setup.nodeInstall': 'Install Node.js',
  'remoteHost.setup.claudeInstall': 'Install Claude CLI',
  ...
  'remoteHost.errors.connectionRefused': 'Connection refused',
  'remoteHost.errors.timeout': 'Connection timed out',
  'remoteHost.errors.sessionNotFound': 'Task state lost, please restart',
