...
const zh: Record<TranslationKey, string> = {
  ...
  'feishu.step1': '点击上方「创建并绑定飞书应用」按钮，浏览器会自动打开飞书授权页面',
  'feishu.step2': '在飞书页面中选择工作区并确认创建，Bot 能力、权限和事件订阅会自动配置',
  'feishu.step3': '创建完成后回到本页面，前往「远程桥接」总览页启动桥接即可开始使用',
  ...
  'assistant.taskDetails': '任务详情',
  'assistant.taskSchedule': '调度',
  'assistant.taskLastResult': '最近结果',
  'assistant.taskRunHistory': '执行历史',
  'assistant.taskRunNow': '立即执行',
  'assistant.taskBridgeChannel': 'Bridge 推送',
  'assistant.taskBridgeNone': '无',
  'assistant.taskBridgeNotRunning': 'Bridge 未运行',
  'assistant.taskRunDuration': '耗时',
  'assistant.taskNoLogs': '暂无执行历史',
  'assistant.taskEdit': '编辑',
  'assistant.taskSave': '保存',
  'assistant.taskCancel': '取消',
  'assistant.taskPause': '暂停',
  'assistant.taskResume': '恢复',
  'assistant.taskName': '名称',
  ...
  'cliTools.addToolBinPathPlaceholder': '输入绝对路径，如 /usr/local/bin/mytool',
  ...
  'remoteHost.analyzeLog': 'AI 分析',
  'remoteHost.analyzeLog.analyzing': '正在分析日志...',
  'remoteHost.analyzeLog.success': '日志分析完成',
  'remoteHost.analyzeLog.error': '分析日志失败',
  'remoteHost.analyzeLog.noFile': '未找到远程日志文件',
  'remoteHost.analyzeLog.dialog.title': 'AI 日志分析',
  'remoteHost.analyzeLog.dialog.close': '关闭',
  'remoteHost.analyzeLog.dialog.reanalyze': '重新分析',
  'remoteHost.analyzeLog.dialog.provider': '服务商',
  'remoteHost.analyzeLog.dialog.model': '模型',
  'remoteHost.addHost': '添加主机',
  'remoteHost.connect': '连接',
  'remoteHost.disconnect': '断开',
  'remoteHost.reconnect': '重连',
  'remoteHost.status.disconnected': '未连接',
  'remoteHost.status.connecting': '连接中',
  'remoteHost.status.connected': '已连接',
  'remoteHost.status.reconnecting': '重连中',
  'remoteHost.status.failed': '连接失败',
  'remoteHost.form.name': '主机名称',
  'remoteHost.form.host': '主机地址',
  'remoteHost.form.port': '端口',
  'remoteHost.form.username': '用户名',
  'remoteHost.form.authType': '认证方式',
  'remoteHost.form.authKey': 'SSH 密钥',
  'remoteHost.form.authPassword': '密码',
  'remoteHost.form.keyPath': '密钥路径',
  'remoteHost.form.password': '密码',
  'remoteHost.form.workDir': '工作目录',
  'remoteHost.setup.checking': '检测远程环境...',
  'remoteHost.setup.nodeInstall': '安装 Node.js',
  'remoteHost.setup.claudeInstall': '安装 Claude CLI',
  ...
  'remoteHost.errors.connectionRefused': '连接被拒绝',
  'remoteHost.errors.timeout': '连接超时',
  'remoteHost.errors.sessionNotFound': '任务状态丢失，请重新发起',
